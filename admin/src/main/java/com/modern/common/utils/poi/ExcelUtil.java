package com.modern.common.utils.poi;
...
import com.modern.common.annotation.Excel.Type;
...
import com.modern.common.core.text.Convert;
import com.modern.common.exception.UtilException;
import com.modern.common.utils.DateUtils;
import com.modern.common.utils.DictUtils;
import com.modern.common.utils.StringUtils;
import com.modern.common.utils.file.FileTypeUtils;
import com.modern.common.utils.file.FileUtils;
import com.modern.common.utils.file.ImageUtils;
import com.modern.common.utils.reflect.ReflectUtils;
            ...
            for (int i = titleNum + 1; i <= rows; i++) {
                ...
                for (Map.Entry<Integer, Object[]> entry : fieldsMap.entrySet()) {
                    ...
                    if (String.class == fieldType) {
                        ...
                        val = LocalDateTime.parse(formatter.format(val), LocalDateUtils.FORMAT_YYYY_MM_DD_HH_MM_SS);
        ...
        for (String item : convertSource) {
            ...
            if (StringUtils.containsAny(separator, propertyValue)) {
                ...
                if (itemArray[1].equals(propertyValue)) {
                    return itemArray[0];
                }else if ("true".equals(itemArray[0]) && "true".equals(propertyValue) || "false".equals(itemArray[0]) && "false".equals(propertyValue)){
                    return itemArray[0];
                }
            }
        }
