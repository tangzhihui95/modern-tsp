...
@RestController
@Api(tags = "TSP - 角色车辆关联")
@RequestMapping("/tsp/vehicle-role")
public class XTspVehicleSysRoleController extends BaseController {

    @Autowired
    private XTspVehicleSysRoleService tspVehicleSysRoleService;

    @ApiOperation("查询所有车辆角色关联列表")
    @PreAuthorize("@ss.hasPermi('tsp:vehicle-role:list')")
    @GetMapping("/list")
    public TableDataInfo list() {
        startPage();
        List<TspVehicleSysRoleVO> list = tspVehicleSysRoleService.getTspVehicleSysRoleVOOfAll();
