...
public class TspVehicleFindFourTeenDayService implements TspVehicleBaseFindDataService {
    ...
    public List<TspVehicleVolumeDataDTO> findVolumeData(TspVehicleVolumeDataVO vo) {
        return tspVehicleMapper.findVolumeDataDays(14);
    }
}
