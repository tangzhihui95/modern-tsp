 ...
 * @author piaomiao
 * @version V1.0.0
 * @date 2022/7/19 12:34
 * <p>
 * 湖南成为科技有限公司 Copyright © 2016 HuNan Become Technology Co., Ltd. All rights reserved
 */
@Service
@RequiredArgsConstructor(onConstructor = @__(@Autowired))
public class TspVehicleFindThirtyDaysService implements TspVehicleBaseFindDataService {
    ...
    public List<TspVehicleVolumeDataDTO> findVolumeData(TspVehicleVolumeDataVO vo) {
        return tspVehicleMapper.findVolumeDataDays(30);
    }
}