...
/**
 * <p>
 * vehicle_extreme;极值数据 Mapper 接口
 * </p>
 *
 * @author piaomiao
 * @since 2022-06-22
 */
public interface VehicleExtremeMapper extends BaseMapperPlus<VehicleExtreme> {
    @Select({"SELECT " +
            "t.* " +
            "FROM " +
            "vehicle_extreme t " +
    ...
    IPage<VehicleExtreme> getPageList(Page<VehicleExtreme> of, @Param(Constants.WRAPPER) Wrapper<VehicleExtreme> ew);
}
