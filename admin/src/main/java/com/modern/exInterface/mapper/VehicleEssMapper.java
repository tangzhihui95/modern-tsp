...
/**
 * <p>
 * vehicle_ess;可充电储能装置电压数 Mapper 接口
 * </p>
 *
 * @author piaomiao
 * @since 2022-06-22
 */
public interface VehicleEssMapper extends BaseMapperPlus<VehicleEss> {
    ...
    IPage<VehicleEss> getPageList(Page<VehicleEss> page, @Param(Constants.WRAPPER) Wrapper<VehicleEss> ew);
}
