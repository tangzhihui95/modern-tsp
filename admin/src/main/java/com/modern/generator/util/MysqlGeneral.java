package com.modern.generator.util;
 ...
 * @author zhouhouqi
 * @version V1.0
 * @package com.henry.baseframe.auth.util
 * @description: ${todo}
 * @date 2020/4/13 8:30 PM
 */
public class MysqlGeneral {

    /**
     * 包名
     */
    private static final String PACKAGE_NAME = "com.modern";
    /**
     * 模块名称
     */
    private static final String MODULE_NAME = "tsp";
    /**
     * 输出文件的路径
     */
    private static final String OUT_PATH = "D:\\piaomiao";
    // private static final String OUT_PATH = "D:\\idea_project";
    /**
     * 代码生成者
     */
    private static final String AUTHOR = "piaomiao";

    /**
     * JDBC相关配置
     */
    private static final String DRIVER = "com.mysql.cj.jdbc.Driver";
    private static final String URL = "jdbc:mysql://39.98.85.96:3306/modern?useUnicode=true&characterEncoding=UTF-8&useSSL=false";
    private static final String USER_NAME = "myuser";
    private static final String PASSWORD = "myuser_PASSWORD57";
    ...
    public static void main(String[] args) {
        ...
        gc.setXmlName("%sMapper").setMapperName("%sMapper");
        // gc.setServiceName("MP%sService")
        // gc.setServiceImplName("%sServiceDi
...
//                                .setDbColumnUnderline(true)// 全局下划线命名
                                ...
                                .setInclude(new String[]{"tsp_tbox_version"}) // 需要生成的表
